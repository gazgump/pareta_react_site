...
const Solutions = () => {
  ...
  const url = 'https://pareta-strapi.fly.dev/api/solution';
  ...
  return (
    <>
      ...
      <FadeIn delay={100} duration={1000}>
        ...
        <div className='bg-white py-10 px-8 lg:py-10 md:px-20 lg:px-30 xl:px-60 2xl:px-70 flex flex-col justify-center items-center'>
            <div className="text-xl lg:text-2xl" dangerouslySetInnerHTML={{__html: data.overview }}></div>
        </div>

        <section className='px-6 md:px-20 lg:px-30 xl:px-60 2xl:px-70 pb-0 lg:pb-20'>
        ...
        <div className='bg-white py-10 px-8 lg:py-10 md:px-20 lg:px-30 xl:px-60 2xl:px-70 flex flex-col justify-center items-center'>
            <div className="text-xl lg:text-2xl" dangerouslySetInnerHTML={{__html: data.bottomText }}></div>
        </div>
        ...
        <div className="col-span-12 bg-gray-800">
          <div className="2xl:container 2xl:mx-auto py-12 px-8 lg:px-24">
              ...
              <div className='flex flex-start items-center justify-center mb-6'>
                <img src={data.bannerIconLink} className="w-8 mr-4" alt={data.bannerIconAlt}/>
                <h3 className="text-white text-center font-poppins font-bold text-2xl lg:text-3xl">{data.bannerTitle}</h3>
              </div>

              <ul>
                <li className='mb-2 lg:mb-4 text-center text-xl lg:text-2xl'>{data.bannerItem1}</li>

                <li className='mb-2 lg:mb-4 text-center text-xl lg:text-2xl'>{data.bannerItem2}</li>

                <li className='mb-2 lg:mb-4 text-center text-xl lg:text-2xl'>{data.bannerItem3}</li>

                <li className='mb-2 lg:mb-4 text-center text-xl lg:text-2xl'>{data.bannerItem4}</li>
